...
const Add = ({navigation}) => {
   ...
   // memilih gambar dari camera atau gallery
    ...
    return (
        <Container>
            <Content>
                {/* text "input kalau height ditambah akan memanjang ke kanan, sedangkan kalau textarea akan memanjang ke bawah" */}
                ...
                <Button style={[btn, bg.purple, m.ten]} onPress={onChooseImage} >
