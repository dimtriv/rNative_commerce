...
import {Container, Header, Content, List, ListItem, Card, CardItem, Thumbnail, Text, Button, Icon, Left, Body, Spinner} from 'native-base'
...
export default function DetailProduct({route}) {
    ...
    const addToCart = () => {
        ...
        .then(res => Alert.alert("barang telah berhasil dimasukkan ke cart"))
        .catch(err => console.log({err}))
    }
